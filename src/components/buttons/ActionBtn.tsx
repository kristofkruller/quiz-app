...
const ActionBtn = ({ content, onClick }: BtnProp) => {
    const colors = {
        ...
        ? "bg-gray-700 dark:bg-gray-200/60 hover:bg-gray-500/80 dark:hover:bg-gray-100/80 text-lg text-gray-300 dark:text-purple-600 hover:text-white dark:hover:text-purple-500" 
